...
func newSavedArea(db *gorm.DB, opts ...gen.DOOption) savedArea {
	...
	_savedArea.savedAreaDo.UseModel(&model.SavedArea{})
...
type ISavedAreaDo interface {
	...
	Create(values ...*model.SavedArea) error
	CreateInBatches(values []*model.SavedArea, batchSize int) error
	Save(values ...*model.SavedArea) error
	First() (*model.SavedArea, error)
	Take() (*model.SavedArea, error)
	Last() (*model.SavedArea, error)
	Find() ([]*model.SavedArea, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.SavedArea, err error)
	FindInBatches(result *[]*model.SavedArea, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.SavedArea) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.SavedArea, error)
	FirstOrCreate() (*model.SavedArea, error)
	FindByPage(offset int, limit int) (result []*model.SavedArea, count int64, err error)
...
func (s savedAreaDo) Create(values ...*model.SavedArea) error {
	if len(values) == 0 {
		return nil
	}
...
func (s savedAreaDo) CreateInBatches(values []*model.SavedArea, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s savedAreaDo) Save(values ...*model.SavedArea) error {
	if len(values) == 0 {
		return nil
	}
...
func (s savedAreaDo) First() (*model.SavedArea, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.SavedArea), nil
	}
}

func (s savedAreaDo) Take() (*model.SavedArea, error) {
...
func (s savedAreaDo) Last() (*model.SavedArea, error) {
...
func (s savedAreaDo) Find() ([]*model.SavedArea, error) {
	result, err := s.DO.Find()
	return result.([]*model.SavedArea), err
}

func (s savedAreaDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.SavedArea, err error) {
	buf := make([]*model.SavedArea, 0, batchSize)
...
func (s savedAreaDo) FindInBatches(result *[]*model.SavedArea, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s savedAreaDo) FirstOrInit() (*model.SavedArea, error) {
...
func (s savedAreaDo) FirstOrCreate() (*model.SavedArea, error) {
...
func (s savedAreaDo) FindByPage(offset int, limit int) (result []*model.SavedArea, count int64, err error) {
...
func (s savedAreaDo) Delete(models ...*model.SavedArea) (result gen.ResultInfo, err error) {
